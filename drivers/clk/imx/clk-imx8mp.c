...
static int imx8mp_clocks_probe(struct platform_device *pdev)
{
	...
	if (of_find_compatible_node(NULL, NULL, "variscite,imx8mp-var-som"))
		is_som = true;
	...
	if(is_som) {
		...
		hws[IMX8MP_CLK_UART1] = imx8m_clk_hw_composite_critical("uart1", imx8mp_uart1_sels, ccm_base + 0xaf00);
